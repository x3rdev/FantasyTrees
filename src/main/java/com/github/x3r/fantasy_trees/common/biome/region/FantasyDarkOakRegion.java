...
public class FantasyDarkOakRegion extends Region {
    ...
    public FantasyDarkOakRegion(ResourceLocation name, int weight) {
    ...
    public void addBiomes(Registry<Biome> registry, Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> mapper) {
        this.addModifiedVanillaOverworldBiomes(mapper, builder -> {
            builder.replaceBiome(Biomes.DARK_FOREST, BiomeRegistry.FANTASY_DARK_FOREST);
            ...
            fantasyForestPoints.forEach(parameterPoint -> builder.replaceBiome(parameterPoint, BiomeRegistry.FANTASY_DARK_FOREST));
        });
    }
}
